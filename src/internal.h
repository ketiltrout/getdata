...
#endif
#if defined HAVE_DECL_HAVE_DECL_GET_UNALIGNED && \
  HAVE_DECL_HAVE_DECL_GET_UNALIGNED == 1
...
#endif
#if defined HAVE_DECL_HAVE_DECL_PUT_UNALIGNED && \
  HAVE_DECL_HAVE_DECL_PUT_UNALIGNED == 1
