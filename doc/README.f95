...
* character (len=GD_FIELD_LEN) function fgd_get_format_filename(dirfile_unit,
  ind)
  integer, intent(in) :: dirfile_unit, ind

  (GD_FIELD_LEN is a constant parameter defined in the module.)

* integer function fgd_get_nfields (dirfile_unit)
  integer, intent(in) :: dirfile_unit

  * integer function fgd_get_nfields_by_type (dirfile_unit, type)
  integer, intent(in) :: dirfile_unit, type

* integer function fgd_get_nvectors (dirfile_unit)
  integer, intent(in) :: dirfile_unit

* integer function fgd_get_nmetafields (dirfile_unit, parent)
  integer, intent(in) :: dirfile_unit
  character, intent(in) :: parent

* integer function fgd_get_nmetafields_by_type (dirfile_unit, parent, type)
  integer, intent(in) :: dirfile_unit, type
  character, intent(in) :: parent

* integer function fgd_get_nmetavectors (dirfile_unit, parent)
  integer, intent(in) :: dirfile_unit
  character, intent(in) :: parent

* integer function fgd_get_nformats (dirfile_unit)
  integer, intent(in) :: dirfile_unit

* integer function fgd_get_nframes (dirfile_unit)
  integer, intent(in) :: dirfile_unit

* integer function fgd_get_spf (dirfile_unit, field_code)
  integer, intent(in) :: dirfile
  character (len=*), intent(in) :: field_code
...
* subroutine fgd_add_spec (dirfile, spec, format_file)
...
* subroutine fgd_madd_multiply (dirfile, parent, field_name, in_field1,
  in_field2)
  integer, intent(in) :: dirfile
...
* character (len=GD_FIELD_LEN) function fgd_get_reference (dirfile)
  integer, intent(in) :: dirfile
...
* integer function fgd_get_encoding (dirfile, fragment)
...
* integer function fgd_get_protection (dirfile, fragment)
  integer, intent(in) :: dirfile, fragment

* subroutine fgd_protect (dirfile, protection_level, fragment)
  integer, intent(in) :: dirfile, protection_level, fragment

* integer function fgd_get_native_type (dirfile, field_code)
  integer integer(in) :: dirfile
  character (len=*), intent(in) :: field_code

* integer function fgd_get_parent_fragment (dirfile, fragment)
  integer, intent(in) :: dirfile, fragment

* subroutine fgd_uninclude (dirfile, fragment, del)
  integer, intent(in) :: dirfile, fragment, del

* character (len=GD_MAX_LINE_LENGTH) function fgd_get_raw_filename (dirfile,
  field_code)
  integer, intent(in) :: dirfile
  character (len=*), intent(in) :: field_code
...
* integer function fgd_get_entry_type (dirfile, field_code)
  integer, intent(in) :: dirfile
  character (len=*), intent(in) :: field_code

* integer function fgd_get_fragment_index (dirfile, field_code)
  integer, intent(in) :: dirfile
  character (len=*), intent(in) :: field_code
...
* double precision function fgd_get_framenum (dirfile, field_code, value)
  integer, intent(in) :: dirfile
  character (len=*), intent(in) :: field_code
  double precision, intent(in) :: value

* double precision function fgd_get_framenum_subset (dirfile, field_code, value,
...
* integer fgd_get_field_name_max (dirfile_unit)
  integer, intent(in) :: dirfile_unit

  This function returns the length of the longest field name defined in the
  dirfile.

* integer fgd_get_mfield_name_max (dirfile_unit, parent)
  integer, intent(in) :: dirfile_unit
  character (len=*), intent(in) :: parent
...
* subroutine fgd_get_field_list (field_list, dirfile, field_len)
  ...
  is equivalent to the return value of fgd_get_field_name_max) and field_list
  will remain untouched.  The character strings returned are Fortran strings.

  Analogously:

* subroutine fgd_get_field_list_by_type (field_list, dirfile, entype, field_len)
  character (len=<field_len>) dimension(:), intent(out) :: field_list
  integer, intent(in) :: dirfile_unit, entype
  integer, intent(inout) :: field_len
* subroutine fgd_get_vector_list (field_list, dirfile, field_len)
  character (len=<field_len>) dimension(:), intent(out) :: field_list
  integer, intent(in) :: dirfile_unit
  integer, intent(inout) :: field_len

  Also analogously, except that field_len will be equivalent to the return
  value of fgd_get_mfield_name_max, if too small:

* subroutine fgd_get_mfield_list (field_list, dirfile, field_len)
  character (len=<field_len>) dimension(:), intent(out) :: field_list
  integer, intent(in) :: dirfile_unit
  integer, intent(inout) :: field_len
  character (len=*), intent(in) :: parent
* subroutine fgd_get_mfield_list_by_type (field_list, dirfile, entype,
  field_len)
  character (len=<field_len>) dimension(:), intent(out) :: field_list
  integer, intent(in) :: dirfile_unit, entype
  integer, intent(inout) :: field_len
  character (len=*), intent(in) :: parent
* subroutine fgd_get_mvector_list (field_list, dirfile, field_len)
  character (len=<field_len>) dimension(:), intent(out) :: field_list
  integer, intent(in) :: dirfile_unit
  integer, intent(inout) :: field_len
  character (len=*), intent(in) :: parent
...
* integer function fgd_get_entry (dirfile_unit, field_code, ent)
  integer, intent(in) :: dirfile_unit
  character (len=*), intent(in) :: field_code
